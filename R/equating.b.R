  ...
  private = list(
        ...
        self$results$instructions1$setContent(
          private$.htmlwidget$generate_accordion(
            ...
            content = paste(
              ...
              '<li>If an error message such as "could not find function ns" appears, please change Form x and Form y variables.</li>',
              '<li>The R package <b>equi</b>(Wolodzko, 2020) is described in the <a href="https://rdrr.io/github/twolodzko/equi/man/equi.html" target = "_blank">page</a>.</li>',
              '<li>Feature requests and bug reports can be made on my <a href="https://github.com/hyunsooseol/snowRMM/issues" target="_blank">GitHub</a>.</li>',
              '</ul></div></div>'
            )
    ...
    .run = function() {
      ...
      if (self$options$mode == 'simple') {
        ...
        if (length(self$options$ind) < 1 | length(self$options$dep) < 1)
          return()
      ...
      if (self$options$mode == 'complex') {
        ...
        if (length(self$options$ind1) < 1 | length(self$options$dep1) < 1)
          return()
        ...
        if (self$options$design == 'single') {
          ...
          eq <- equi::equi(
            equi::smoothtab(data[[ind1]]),
            equi::smoothtab(data[[dep1]])
          )
        }
    ...
    .plot1 = function(image1, ggtheme, theme, ...) {
      ...
      if (length(ind1) < 1 | length(dep1) < 1)
        return(FALSE)
